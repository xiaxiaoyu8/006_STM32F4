...
================  创建寄存器模板工程重点说明 ======================
![主编程页面](images/image-40.png)

C/C++-Define:
STM32F40_41xxx,USE_STDPERIPH_DRIVER
![C/C++选项卡](images/image-41.png)
...
![在寄存器模板上,C/C++选项卡新增的几个路径](images/image-43.png)
!["品"字型工具](images/image-42.png)
...
# 如果要在寄存器模板基础上创建标准库
将三个文件和两个文件夹放在FWLib文件夹下![两个文件夹在固件库的路径](images/image-45.png)![三个文件在固件库的路径](images/image-44.png)
![效果](images/image-46.png)
